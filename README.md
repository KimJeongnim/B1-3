...
Google Sheets에 새로운 출석 정보가 등록되면 워크플로우가 자동으로 실행되어 Discord 채널에 해당 정보를 전송하도록 구성하였다.

---

## 자동 실행 구조

Google Sheets에 새로운 행이 등록되는 순간 Google Sheets Trigger가 실행되어 새로운 출석 정보를 감지한다.
...
Google Sheets에 출석 정보가 등록되면 Discord 채널에 입실 또는 퇴실 알림이 자동으로 전송되는 것을 확인하였으며, 워크플로우가 정상적으로 동작함을 검증하였다.
...
- 반복 업무를 자동화하여 업무 효율성과 정확성을 향상시킬 수 있다.
- 실시간 정보 공유를 통해 신속한 의사소통이 가능하다.
---
...
이번 프로젝트를 통해 자동화 기술은 반복 업무의 효율성과 정확성을 높이는 데 매우 효과적이라는 점을 확인할 수 있었으며, 앞으로는 다양한 업무에 자동화를 적용하여 업무 효율성을 높일 수 있는 프로젝트를 지속적으로 수행해 보고자 한다.
